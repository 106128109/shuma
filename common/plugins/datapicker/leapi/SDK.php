...
class SDK
{
	 ...
	 * @var string $gateway
	 */
	public $gateway = 'https://api03.6bqb.com';
	...
	{
		$class_name = sprintf('common\plugins\%s\%s\%s', $instance, $code, ucfirst($config['platform']));
		$sdk = new $class_name($config);
